...
<head>
    ...
    <script src="{{ asset('sweetalert/js/sweetalert2@10.js') }}"></script>
</head>
...
<body class="login-page sidebar-collapse">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('login/mahasiswa') }}" class="btn btn-info">
    ...
    <div class="page-header header-filter" style="background-image: url('{{ asset('img/beasiswa.jpg') }}'); background-size: cover; background-position: top center;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                    <div class="card card-login">
                        <form method="POST" action="{{ url('register/mahasiswa') }}">
                            @csrf
                            <div class="card-header card-header-primary text-center">
                                <h4 class="card-title">Register</h4>
                                <p class="text-center">Silahkan register terlebih dahulu.</p>
                            </div>
                            <div class="card-body">
                                <div class="input-group">
                                    ...
                                    <input placeholder="Nama lengkap..." type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" required autocomplete="nama" autofocus>
                                    @error('nama')
