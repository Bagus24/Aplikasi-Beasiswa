        ...
        <div class="card-body">
            <form method="POST" action="{{ route('formulir.update', $formulir->id) }}" enctype="multipart/form-data">
                ...
                <div class="col">
                    ...
                    <input type="hidden" class="form-control @error('id_user') is-invalid @enderror" value="{{ $formulir->id_user }}" name="id_user" required>
                    @error('id_user')
                    ...
                    <input type="hidden" class="form-control @error('nama') is-invalid @enderror" value="{{ $formulir->nama }}" name="nama" required>
                    @error('nama')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
